...
if ! site7=$(diff site7 date); then
	dispo "Mairie Centre - Victor Hugo: " "$site7"
	notify-send 'Mairie Centre - Victor Hugo' "$rdvlink $site7"
else
	dispo "Mairie Centre - Victor Hugo: " "Pas de RDV"
fi
...
if ! site3=$(diff site3 date); then
	dispo "Mairie de quartier Blosne: " "$site3"
	notify-send 'Mairie de quartier Blosne' "$rdvlink $site3"
else
	dispo "Mairie de quartier Blosne: " "Pas de RDV"
fi
...
if ! site8=$(diff site8 date); then
	dispo "Mairie de quartier Bréquigny: " "$site8"
	notify-send 'Mairie de quartier Bréquigny' "$rdvlink $site8"
else
	dispo "Mairie de quartier Bréquigny: " " Pas de RDV"
fi
...
if ! site2=$(diff site2 date); then
	dispo "Mairie de quartier Maurepas Europe: " "$site2"
	notify-send 'Mairie de quartier Maurepas Europe' "$rdvlink $site2"
else
	dispo "Mairie de quartier Maurepas Europe: " "Pas de RDV"
fi
...
if ! site4=$(diff site4 date); then
	dispo "Mairie de quartier Villejean: " "$site4"
	notify-send 'Mairie de quartier Villejean' "$rdvlink $site4"
else
	dispo "Mairie de quartier Villejean: " "Pas de RDV"
fi
